...
function onCreate()
	...
	makeLuaSprite('sonics', 'bg/sonic', 0, 0);
	addLuaSprite('sonics', false);

	makeLuaSprite('fleetways', 'bg/fleetway', 0, 0);
	addLuaSprite('fleetways', false);
	setProperty('fleetways.alpha', 0);
